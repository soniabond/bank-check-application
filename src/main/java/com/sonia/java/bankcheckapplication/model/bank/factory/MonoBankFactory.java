...
@Component
@Scope("prototype")
public class MonoBankFactory extends BankFactory{


    @Autowired
    public MonoBankFactory(@Qualifier("monoBankResponseParser") ResponseParser parser,
                           @Qualifier("monoBankWebApiDataReceiver") BankDataReceiver dataReceiver,
                           @Qualifier("monoBankDischargeRequest") DischargeRequestData dischargeRequestData,
                           @Qualifier("monoBankBalanceRequestData") BalanceRequestData balanceRequestData
    ) {
        this.parser = parser;
